...
> extends DatabaseRepositoryAbstract<EntityDocument> {
    ...
    async findAllDistinct<T = EntityDocument>(
        ...
        return findAll.exec() as Promise<T[]>;
    }
    ...
    async create<Dto = unknown>(
        ...
        const dataCreate: Record<string, unknown> = { ...(data as Record<string, unknown>) };
    ...
    async save(
        ...
        return repository.save(options as SaveOptions);
    }
    ...
    async delete(
        ...
        return repository.deleteOne(options as QueryOptions<unknown>);
    }
