...
/** Режим проверки пароля: strict — 8+ символов, верхний/нижний регистр и цифра; registration — 6+ символов, буквы и цифры */
export type HelperStringPasswordRule = 'strict' | 'registration';

export interface IHelperStringPasswordOptions {
    length?: number;
    rule?: HelperStringPasswordRule;
}
