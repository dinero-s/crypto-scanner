    ...
    intercept(
        ...
        if (context.getType() === 'http') {
            return next.handle().pipe(
                map(async (res: Promise<IResponsePaging<unknown>>) => {
                    ...
                    // response
                    const responseData = (await res) as IResponsePaging<unknown>;
                    if (!responseData) {
                        throw new Error(
                    ...
                    metadata = {
                        ...
                        pagination: {
                            ...xPagination,
                            ...(metadata._pagination as Record<string, unknown>),
                            total,
                    ...
                    return {
                        ...
                        page: page,
                        pagingCounter: (page - 1) * perPage + 1,
                        hasPrevPage: page > 1,
